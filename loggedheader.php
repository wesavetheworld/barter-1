...
<!--        <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>-->
    ...
    <div class="container" style="height: 70px;">
        <span ><a href="index.php"><img src="img/logo.png" width="110px" alt="Burter"></a> </span> <span style="font-family: sans-serif;font-size: 20px;"> Exchange Every Thing Here</span>

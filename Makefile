...
SHELL = /bin/sh
srcdir = /Users/yunfeiyang/Downloads/htk/HLMLib
top_srcdir = /Users/yunfeiyang/Downloads/htk
VPATH = /Users/yunfeiyang/Downloads/htk/HLMLib
prefix = /usr/local
exec_prefix = ${prefix}
...
CC = gcc
CFLAGS = -ansi -g -O2 -DNO_AUDIO -D'ARCH="darwin"' -I/usr/include/malloc -Wall -Wno-switch -g -O2 -DSANITY -I. -I../HTKLib/
RANLIB = ranlib
